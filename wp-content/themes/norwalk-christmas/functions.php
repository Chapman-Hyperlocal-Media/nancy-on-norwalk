...
if( !function_exists('norwalk_meta') ):
		...
		function norwalk_meta($class, $loc = 'side'){
			...
			echo '<li class="byline"><span class="tagline">By </span>' . get_the_author() . '</li>';
...
function norwalk_flex_caption($wtf, $attr, $content){
	...
	. do_shortcode( $content ) . '<div class="wp-caption-text"><p>' . $caption . '</p></div><div class="inner-shadow top left"></div><div class="inner-shadow top right"></div><div class="inner-shadow left"></div><div class="inner-shadow right"></div></div>';
}
