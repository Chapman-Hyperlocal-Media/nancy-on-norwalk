...
<?php
    ...
    wp_enqueue_script('norwalk-js', get_template_directory_uri() . '/js/min/norwalk.min.js', 'jquery', '1.3.2-1');
    wp_enqueue_script('modernizr', get_template_directory_uri() . '/js/modernizr.custom.99437.js');
    wp_enqueue_script('norwalk-ads', get_template_directory_uri() . '/js/min/norwalk-ads.min.js', 'jquery', '1.3.2-1');
