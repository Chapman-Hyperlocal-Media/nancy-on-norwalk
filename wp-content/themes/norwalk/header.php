...
<?php
    ...
    wp_enqueue_script('norwalk-js', get_template_directory_uri() . '/js/min/norwalk.min.js', 'jquery', '1.3.6');
    wp_enqueue_script('modernizr', get_template_directory_uri() . '/js/min/modernizr.custom.99437.min.js');
    wp_enqueue_script('norwalk-ads', get_template_directory_uri() . '/js/min/norwalk-ads.min.js', 'jquery', '1.3.6');
    wp_enqueue_style('norwalk-css', get_template_directory_uri() . '/stylesheets/layout.css', '1.3.6');
?>
