...
require_once( $THEME_DIR  . '/includes/sidebars.php' );
require_once( $THEME_DIR  . '/includes/sidebar-fallback.php' );
require_once( $THEME_DIR  . '/includes/bylines.php' );
require_once( $THEME_DIR  . '/includes/image-captions.php' );
require_once( $THEME_DIR  . '/includes/social-media.php' );
require_once( $THEME_DIR  . '/includes/post-meta.php' );
require_once( $THEME_DIR  . '/includes/comments.php' );
